...
import Speaker_Diarization.ghostvlad.toolkits as toolkits
import Speaker_Diarization.ghostvlad.model as spkModel
import os
from Speaker_Diarization.visualization.viewer import PlotDiar
...
parser.add_argument('--resume', default=r'D:\Programming\Anaconda\envs\GRA\Lib\site-packages\Speaker_Diarization\ghostvlad\pretrained\weights.h5', type=str)
...
SAVED_MODEL_NAME = 'D:\Programming\Anaconda\envs\GRA\Lib\site-packages\Speaker_Diarization\pretrained\saved_model.uisrnn_benchmark'
...
def main(wav_path, embedding_per_second=1.0, overlap_rate=0.5):
    ...
    f= open("D:\OneDrive - Georgia State University\MSA\Fall 2019\GRA\Data\Sample From Youtube\result.txt","w+")
    ...
    p.draw()
    p.plot.show()
    #p.savefig('D:\\OneDrive - Georgia State University\\MSA\Fall 2019\\GRA\\Data\\Sample From Youtube\\x.png')

if __name__ == '__main__':
    main(r'D:\OneDrive - Georgia State University\MSA\Fall 2019\GRA\Data\A_20121119_Q4 2012 Agilent Technologies Inc. Earnings Conference Call.wav', embedding_per_second=1.2, overlap_rate=0.4)
    #main(r'D:\OneDrive - Georgia State University\MSA\Fall 2019\GRA\Data\Sample From Youtube\ENG 1 Group Discussion Example.wav', embedding_per_second=1.2, overlap_rate=0.4)
